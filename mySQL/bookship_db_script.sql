...
INSERT INTO Authors VALUES(5,'A. P. J. Abdul Kalam','Dr. A.P.J. Abdul Kalam, born Avul Pakir Jainulabdeen Abdul Kalam on October 15, 1931, in Rameswaram, India, was a renowned Indian scientist and the 11th President of India (2002-2007). Often referred to as the "Missile Man of India," he played a pivotal role in India\'s space and missile programs, including the development of the country\'s ballistic missiles and satellite launch vehicles.
Kalam earned his degree in aeronautical engineering from the Madras Institute of Technology and began his career working on satellite and missile technology at the Indian Space Research Organisation (ISRO) and the Defence Research and Development Organisation (DRDO). His contributions were crucial to India\'s successful launch of its first satellite, Aryabhata, and the development of the Agni and Prithvi missiles.','/images/authors/APJAbdulKalam.jpg','2024-07-11 08:21:59','2024-07-11 08:21:59');

INSERT INTO Authors VALUES(6,'Colleen hoover','Colleen Hoover, born on December 11, 1979, in Sulphur Springs, Texas, USA, is a bestselling American author known for her works in contemporary romance and young adult fiction. She gained widespread recognition with her debut novel, "Slammed", which she self-published in 2012. The book\'s success led to her gaining a large following and establishing herself as a prominent figure in the literary world.
...
INSERT INTO Authors VALUES(7,'David Godman','David Godman is a well-regarded author and teacher known for his writings on Sri Ramana Maharshi and other Indian spiritual teachers. Born on March 8, 1954, in the United Kingdom, Godman’s work primarily focuses on the life and teachings of Sri Ramana Maharshi, a revered modern Indian sage. 
